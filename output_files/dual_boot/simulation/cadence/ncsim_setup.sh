...
TOP_LEVEL_NAME="dual_boot"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/blastsail/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cadence/altera_dual_boot.v"   -work dual_boot      -cdslib ./cds_libs/dual_boot.cds.lib     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cadence/alt_dual_boot_avmm.v" -work dual_boot      -cdslib ./cds_libs/dual_boot.cds.lib     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cadence/alt_dual_boot.v"      -work dual_boot      -cdslib ./cds_libs/dual_boot.cds.lib     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dual_boot.v"                                                                                           
fi
